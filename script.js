...
function prepare_gui(title, description) {
	var wrap = $('<div id="outer_container"><div id="customScrollBox"><div class="container"><div class="content"></div></div><div id="dragger_container"><div id="dragger"></div></div></div></div>');
	var bg = $('<div id="bg"></div>');
	var title = $('<h1>').html(title), desc = $('<p>').html(description);
	
	var content = wrap.find('.content');
	content.append(title);
	content.append(desc);
	
	content.append('<div id="toolbar"></div>');
	...
	bg.append('<div id="arrow_indicator"><img src="https://hoangsoft90.github.io/-sideways_jquery_fullscreen_image_gallery/sw_arrow_indicator.png" width="50" height="50"  /></div>');
...
var images=["https://hoangsoft90.github.io/-sideways_jquery_fullscreen_image_gallery/ajax-loader_dark.gif","https://hoangsoft90.github.io/-sideways_jquery_fullscreen_image_gallery/round_custom_scrollbar_bg_over.png"];
